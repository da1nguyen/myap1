                ...
                with data_placeholder:
                    st.write(
                        ...
                        .dataframe thead th:nth-child(1) {{
                            min-width: 700px; /* Kích thước tối thiểu của cột Title */
                        }}
                        .dataframe thead th:nth-child(2) {{
                            min-width: 200px; /* Kích thước tối thiểu của cột Created Time (VN) */
                        }}
                        .dataframe thead th:nth-child(3) {{
                            min-width: 250px; /* Kích thước tối thiểu của cột Sentiment */
                        }}
                        </style>
